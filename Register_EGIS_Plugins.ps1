...
$plugins = @(
    @{
        ...
        DLL    = "$bundleRoot\EGISParameterSync_Plugin.bundle\Contents\Win64\EGISParameterSync_Civil3D.dll"
    },
    @{
        Key    = "EGISTieWithCant"
    ...
    @{
        Key    = "EGISLayoutManager"
        Desc   = "EGIS Smart Tools - Layout Manager"
        DLL    = "$bundleRoot\EGISLayoutManager.bundle\Contents\EGISLayoutManager.dll"
    },
    @{
        Key    = "EGISStreetView"
        Desc   = "EGIS Smart Tools - Street View"
        DLL    = "$bundleRoot\EGISStreetView.bundle\Contents\EGISStreetView.dll"
    }
)
